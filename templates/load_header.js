...
function load_header(login_)
{
	...
	if (login_=="true")
	{
		box=box+"<div class='header_top_style_right' onmouseenter='show_dropdown(2)' onmouseleave='hide_dropdown(2)'><div class='account_overview'> <div class='account_overview_text' onclick='account_aufrufen()'>Profil</div><div class='account_overview_text_leer' onclick='account_aufrufen()'>&nbsp;</div>"
		box=box+"<div class='dropdown_content'>"
		...
		box=box+"<div class='header_top_style_right' onclick='load_registration_login()'> <div class='dropdown_content_registrierung_overview' ><div class='registrierung_overview_text' >Anmelden</div><div class='registrierung_overview_text_leer' >&nbsp;</div></div></div>"	
//<div class='header_top_style_right' onclick='log_out_aufrufen()'>Log-out</div>	
	...
	var box_bottom_1="<div class='box_links'><div><b>Sensuals</b></div><div id='ueber_uns' class='links_header' onclick='link_abrufen(this.id)'>Über uns</div><div id='wie_funktioniert_VIP' class='links_header' onclick='link_abrufen(this.id)'>Wie funktioniert VIP?</div><div id='agb' class='links_header' onclick='link_abrufen(this.id)'>AGB</div></div>";
	var box_bottom_2="<div class='box_links'><div><b>&nbsp;</b></div><div id='datenschutz' class='links_header' onclick='link_abrufen(this.id)'>Datenschutz</div><div id='widerrufsbelehrung' class='links_header' onclick='link_abrufen(this.id)'>Widerrufsbelehrung</div><div id='impressum' class='links_header' onclick='link_abrufen(this.id)'>Impressum</div></div>";
	var box_bottom_3="<div class='box_links'><div><b>Hilfe & Support</b></div><div id='help_center' onclick='open_help_center()' class='links_header' >Help Center</div><div id='support' onclick='link_abrufen(this.id)' class='links_header' >Kontaktiere uns</div></div>";
	var box_bottom_4="<div class='box_links'><div><b>Join us</b></div><div class='links_header' onclick='link_abrufen(this.id)' id='jobs'>Jobs</div><div class='links_header' onclick='link_abrufen(this.id)' id='kontakt_karriere'>Konaktiere uns</div><br><img class='logos' src='/static/facebook.png' /></img><img class='logos' src='/static/instagram.png' /></img><img class='logos' src='/static/twitter.png' /></img></div>";
 ...
 function links_laden(url)
 {
	...
	while (i<=links.length-1)
	{
		if (i==url)
		{
 			...
 			box=box+"<div class='link_gruppen' onclick='content_abrufen("+i+")' onmouseenter='link_markieren("+i+")'>"+links[i].name+"</div>\r"
 			url_lingerie=links[i].name
 		}
 		else
 			box=box+"<div class='link_gruppen' onclick='content_abrufen("+i+")' onmouseenter='link_markieren("+i+")' onmouseleave='link_entmarkieren("+i+")'>"+links[i].name+"</div>\r"
 		i=i+1;
 	}
