...
function open_mobile_added_to_cart(name,picture,bh_groesse,slip_groesse,slip_groesse_2)
{
	...
	if(window.innerWidth<768)
	{
		...
		box=box+"<button class='button_added_to_cart_warenkorb' onclick='cart_aufrufen()'>Zum Warenkorb</button>"		
...
function zurueck_button_mobile_menu()
{
	    ...
	    gtag('event', 'mobile_menu_weitershoppen', {
                              'event_category': 'mobile_menu_weitershoppen_1',
                              'event_label': 'mobile_menu_weitershoppen_2'
	    });	
...
function cart_aufrufen_mobile_menu()
{
	    ...
	    gtag('event', 'mobile_menu_cart_aufrufen', {
                              'event_category': 'mobile_menu_cart_aufrufen_1',
                              'event_label': 'mobile_menu_cart_aufrufen_2'
	    });	
