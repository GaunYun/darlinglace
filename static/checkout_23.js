...
function adresse_anzeigen(existent_rechnungsadresse,existent_lieferadresse)
{
	...
	while(i<=1)
	{
		...
		{
			box=box+"<br><br><div><div class='address_other_input_header' style='float:left;width:100%'>E-Mail Adresse<br><input class='email_input' style='width:100%'";
			box=box+"type='text' value=''></input></div><br>"	
		}
...
function fuege_adressen_hinzu(hinzufuegen_,standard_rechnungsadresse_,standard_lieferadresse_,index_,wie_viele_adressen_checken,hinzufuegen_2,standard_rechnungsadresse_2,index_2)
{
		...
		$.ajax({
			...
			dataType: "json",
			data: { "email":email,"wie_viele_adressen_checken":wie_viele_adressen_checken,"vorname": vorname[0],"nachname": nachname[0],"telefonnummer": mobilnummer[0],
...
function select_shopping_type(shopping_type_)
{
	...
	$.ajax({
					timeout:4500,
					error: function(){
						select_shopping_type(shopping_type_);
						page_load(1);
				button_logo("1","add_to_cart_text","add_to_cart_logo","add_to_cart")	
					},
	type: "GET",
	...
	function VIP_selection_laden(VIP_,shoppingtype,cart_page_)
{
	...
	VIP=VIP_
		...
		if(VIP=="false" && cart_page=="ja")
		{
				...
				box="<br>"
				box=box+"<div class='shopping_selection' onclick='select_shopping_type(0)'><div style='margin-left:5px;margin-top:2px;margin-bottom:2px;' ><img src='/static/radio_box_check_black.png' width='25' style='float:left;padding-top:5px;margin-right:5px;' id='VIP_selection_image'></img><div style='float:left;width:105px;font-size:14px;'><b>VIP Club</b><br>Ab 19,95 € je Set</div></div></div><div class='shopping_selection' onclick='select_shopping_type(1)'><div style='margin-left:5px;margin-top:2px;margin-bottom:2px;' ><img src='/static/radio_box_empty_black.png' width='25' style='float:left;padding-top:5px;margin-right:5px;' id='Reg_selection_image'></img><div style='float:left;width:105px;font-size:14px;'><b>Als Gast kaufen</b><br>Ab 19,95 € je Set</div></div></div><div class='VIP_selection'></div>"
