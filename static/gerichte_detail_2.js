   ...
   function datum_auswahl(ausgewaehlter_tag,index_,ausgewaehlter_wochentag) 	
{
 ...
 {
 	if(lingerie_selection[0].productgroup!="geschenkkarten")
	{
	 	i=0;
	 	...
	 	while(i<=max)
	 	{
		 	...
		 	{
		 		document.getElementsByClassName("bra_size_select")[i].style.backgroundColor="#b51d36";
 ...
 function gtag_event_bra_size()
 {
 
 
 		  		  			gtag('event', 'braz_size_select',{
				  
				  'event_label':lingerie_selection[0].name,
 ...
 function reset_bra_size_select(i)
 {
	if(i==0)
	{
		document.getElementById("bra_size_select_first").style.backgroundColor="#ffffff";
		document.getElementById("bra_size_select_first").style.color="#4d4d4d"; 
	}	


	if(i==1)
	{
		document.getElementById("bra_size_select_second").style.backgroundColor="#ffffff";
		document.getElementById("bra_size_select_second").style.color="#4d4d4d"; 
	}		
	...
	while(i<=sizes.length-1)
	{
		...
		if(sizes[i].type=="BH")
			...
			else
			{
				...
				if("Deine Bralette-Größe ist Bralette "+bralette_size=="Deine Bralette-Größe ist "+sizes[i].size)
				{
...
function open_mobile_added_to_cart(name,picture,bh_groesse,slip_groesse,slip_groesse_2)
{
	...
	{
		box=""
		box=box+"<div style='text-align:center;font-weight:500;font-size:16px;padding-top:10px;'>Hinzugefügt zum Warenkorb</div>"
		box=box+"<div style='height:0.5px;width:calc(100% - 20px);background-color:#000000;margin-bottom:10px;margin-top:10px;margin-left:auto;margin-right:auto;'>&nbsp;</div>"


		box=box+"<img src='"+picture+"' class='cart_added_to_cart'>"

		box=box+"<div style='margin-left:10px;float:left;	width:calc(100% - 150px);font-size:16px;font-weight:500;'>"+name+"</div>"


		
		box=box+"<br><br><div style='float:left;margin-left:10px;font-size:14px;text-align:left;'>BH Größe: <b>"+bh_groesse+"</b></div> <br><br>"
		box=box+"<div style='float:left;margin-left:10px;font-size:14px;text-align:left;'>Slip Größe: <b>"+slip_groesse+"</b></div><br><br>"
		box=box+"<div style='float:left;margin-left:10px;font-size:14px;text-align:left;'>Anzahl: <b>1</b></div><br><br>"
	
	

		
		box=box+"<div style='height:0.5px;width:95%;background-color:#000000;margin-bottom:10px;margin-top:10px;margin-left:auto;margin-right:auto;'>&nbsp;</div>"




		box=box+"<button class='button_added_to_cart_warenkorb' onclick='cart_aufrufen_mobile_menu()'>Zum Warenkorb</button>"		
		box=box+"<button class='button_added_to_cart_shopping' onclick='zurueck_button_mobile_menu()'>Weiter einkaufen</button>"		
		
		
	document.getElementsByClassName("added_to_cart_rectangle")[0].innerHTML=box;
	document.getElementsByClassName("added_to_cart_rectangle")[0].style.display="block";
...
function zurueck_button_mobile_menu()
{
	
		  		  			gtag('event', 'mobile_menu_weitershoppen',{
				  
				  'event_label':'mobile_menu_weitershoppen_1',
				  'event_category': 'ecommerce'
				});	
...
function cart_aufrufen_mobile_menu()
{
		  		  			gtag('event', 'mobile_menu_cart_aufrufen',{
				  
				  'event_label':'mobile_menu_cart_aufrufen_1',
				  'event_category': 'ecommerce'
				});	
...
function get_cart_from_server()
{
					...
					success: function(data) {
										...
										pictures_lingerie=JSON.parse(lingerie_selection[0].pic)
		
			
			
													
										open_mobile_added_to_cart(lingerie_selection[0].name,pictures_lingerie[0].link,bh_groesse,slip_groesse,slip_groesse_2)
									      ...
									      currency: 'EUR' 
											...
											gtag('event', 'add_to_cart', {
											  "items": [
											    {
											      "id": lingerie_selection[0].stylecode+lingerie_selection[0].colorcode,
											      "name": lingerie_selection[0].name,
											      "brand": "Darling Lace",
											      "category": lingerie_selection[0].stylegroup,
											      "list_position": lingerie_selection[0].position,
											      "quantity": 1,
											      "price": String(lingerie_selection[0].pricesubscription)
											    }
											  ]
											});
 ...
 function reset_on_added_to_cart_rectangle()
 {
 	
 	document.getElementsByClassName("added_to_cart_rectangle")[0].style.display="none";
...
function add_cart()
{
	...
	if(check_selected_options()=="ok")
	{
		...
		pricesforaddlpanty_=pricesforaddlpanty[0].priceregular
	...
	if(lingerie_selection[0].productgroup!="geschenkkarten")
	{
		slip_groesse_2=""
	 	...
	 	{
	 		slip_groesse=""
	 		slip_groesse_2=document.getElementsByClassName("bra_size_select")[0].value
	 		bh_groesse=""
	 	}
	 	else
	 	{
	...
	button_logo(0,"button_cart_id_text","button_cart_id_logo","button_cart_id")			
				$.ajax({
					timeout:3000,
					error: function(){
						get_cart_from_server();
						button_logo(1,"button_cart_id_text","button_cart_id_logo","button_cart_id")
					},
					...
					url: "/add/",
					dataType: "json",
					data: {"windowheight":windowheight,"windowwidth":windowwidth,"add_or_erase":"add","stylecode_lingerie": lingerie_selection[0].stylecode,"colorcode_lingerie": lingerie_selection[0].colorcode,"bh_groesse": bh_groesse,"slip_groesse_lingerie": slip_groesse,"slip_groesse_panties":slip_groesse_2,"colorcode_panties": lingerie_selection[0].colorcode },
					success: function(data) {
						...
						if(data=="lingerie not available")
							alert_userdata("BH NICHT VERFÜGBAR","In Deinem gewählten Set ist leider der BH nicht mehr verfügbar. Bitte wähle einen anderen BH aus.")
						else
							if(data=="lingerie_panty not available")
								alert_userdata("SLIP NICHT VERFÜGBAR","In Deinem gewählten Set ist leider der Slip nicht mehr verfügbar. Bitte wähle einen anderen Slip aus.")
							else
								if(data=="panty not available")
									alert_userdata("SLIP NICHT VERFÜGBAR","Der zusätzliche Slip ist leider nicht mehr verfügbar. Bitte wähle einen anderen Slip aus.")
								else
...
function groessentabelle()
{
	...
	groessentabelle_uebersicht=JSON.parse('[[63, 75, 99], [64, 75, 99], [65, 75, 99], [66, 75, 99], [67, 75, 99], [68, 80, 104], [69, 80, 104], [70, 80, 104], [71, 80, 104], [72, 80, 104], [73, 85, 109], [74, 85, 109], [75, 85, 109], [76, 85, 109], [77, 85, 109], [78, 90, 114], [79, 90, 114], [80, 90, 114], [81, 90, 114], [82, 90, 114], [83, 95, 119], [84, 95, 119], [85, 95, 119], [86, 95, 119], [87, 95, 119], [88, 100, 124], [89, 100, 124], [90, 100, 124], [91, 100, 124], [92, 100, 124], [93, 105, 129], [94, 105, 129], [95, 105, 129], [96, 105, 129], [97, 105, 129], [98, 110, 134], [99, 110, 134], [100, 110, 134], [101, 110, 134], [102, 110, 134], [103, 115, 139], [104, 115, 139], [105, 115, 139], [106, 115, 139], [107, 115, 139], [108, 120, 144], [109, 120, 144], [110, 120, 144], [111, 120, 144], [112, 120, 144], [], [], [], [], []]');
"", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", "", ""], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], [], []]]')
 ...
 {
 	link_='https://www.darlinglace.com/Produktauswahl/'+lingerie_selection[0].link+'/'+lingerie_selection[0].name+'/?gutscheincode='+document.getElementsByClassName("gutscheincode")[0].innerHTML
 		FB.ui({
	  method: 'feed',
	  link: link_,
	  	  caption: lingerie_selection[0].name,
	  description: lingerie_selection[0].descriptionshort,
	}, function(response){});
 	
 }
 
 
 function send_email_referral()
 {
 	
 	link="https://www.darlinglace.com/Produktauswahl/"+lingerie_selection[0].link+"/"+lingerie_selection[0].name+"/?gutscheincode="+document.getElementsByClassName("gutscheincode")[0].innerHTML
	 window.location.href = "mailto:?subject="+lingerie_selection[0].name+"&body=<a href='"+link+"'>"+link+"</a>"
 }
...
function test2() 
{
	...
	function t(t,i,n,e)
	{
		...
		return function()
		{
			...
			for(var e=0;n>e;e++)
			{
				var r=document.createElement("li");r.classList.add("c-rating__item_large"),r.setAttribute("data-index",e),i>e&&r.classList.add("is-active"),t.appendChild(r),f.push(r),a(r)
			}
		}(),
		{
			setRating:c,getRating:d
    ...
    function addRatingWidget_large(shopItem, data) {
      var ratingElement = shopItem.querySelector('.c-rating');
      var currentRating = parseInt(data);
      var maxRating = 5;
      var callback = function(rating2) {  };
      var r = rating2(ratingElement, currentRating, maxRating, callback);
    }
	
	    function buildShopItem_large(data,index) {
      var shopItem = document.createElement('div');
...
function pic_change(i)
{
 	...
 	windowheight=window.innerHeight;
		...
		dataType: "json",
		data: { "stylecode": lingerie_selection[0].stylecode,"colorcode": lingerie_selection[0].colorcode, "pictureclicked":lingerie_selection[0].pic[i][0].toString(),"windowheight":windowheight,"windowwidth":windowwidth},
		success: function(data) {
 				detail_picture=JSON.parse(lingerie_selection[0].pic);
				document.getElementsByClassName("bild-laden")[0].src=detail_picture[i].link
				j=0;
				while(j<=detail_picture.length-1)
				{
 ...
 function set_header_color(id)
 {
	...
	if(window.innerWidth<568)
	{
		 ...
		 if(id==0)
		 {
			...
			document.getElementsByClassName("logo_huelle")[0].innerHTML ="<b>"+lingerie_selection[0].name+"</b>";	
...
function set_top_header_invisible()
{
	document.getElementsByClassName("sidebar")[0].style.display ="none";	
	...
	document.getElementsByClassName("header_top_line")[0].style.display ="none";	
	
		document.getElementsByClassName("header_top_line")[1].style.display ="none";	
}

function set_top_header_visible()
{
	...
	document.getElementsByClassName("header_top")[0].style.backgroundColor ="#b51d36";	
			...
			document.getElementsByClassName("mobile_back")[0].style.display ="block";	
		set_header_color(1)
	document.getElementsByClassName("header_top_line")[0].style.display ="block";	
	
		document.getElementsByClassName("header_top_line")[1].style.display ="block";		
   ...
   function initial_setup(resize_)
   {
			...
			var theElement = document.getElementById("overall_page");
			
			theElement.addEventListener("touchstart", reset_on_added_to_cart_rectangle, false);
	...
	var small_pics= document.getElementsByClassName("images_small");
		...
		if(window.innerWidth>=568)
		{
			...
			lingerie_selection_details=lingerie_selection[0].details.toString()
			lingerie_selection_details=lingerie_selection_details.split('<br>')
	//		title_1=lingerie_selection_details[0].substring(2, lingerie_selection_details[0].length);
	//		title_2=lingerie_selection_details[1].substring(2, lingerie_selection_details[1].length);
			title_1=""
			title_2=""
			set_top_header_visible()
			box="<img class='bild-laden' src='"+pictures_lingerie[0].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[0].title+"' ></img>"
		...
		else
		{
			...
			document.getElementsByClassName("bewertungsblock")[0].style.borderTop="1.0px solid #e6e6e6";

			document.getElementsByClassName("bewertungsblock")[0].style.paddingTop="20px";
			box="<div class='swiper-container'><div class='swiper-wrapper'>"
			i=0;
			while(i<=pictures_lingerie.length-1)
			{
			...
			title_1=lingerie_selection_details[0].substring(2, lingerie_selection_details[0].length);
			title_2=lingerie_selection_details[1].substring(2, lingerie_selection_details[1].length);
				box=box+"<div class='swiper-slide'><img class='bild-laden' src='"+pictures_lingerie[i].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[i].title+"' onclick='pic_change("+i+")'></img></div>"
				i=i+1;
			}
	...
	title_2="";
		while(i<=pictures_lingerie.length-1)
		{
			...
			if(pictures_lingerie[i].link!="")
			{	
				if(i==0 || i==4 || i==8)
					box=box+"<div class='small_pictures_huelle_1'><img  class='small_pictures' src='"+pictures_lingerie[i].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[i].title+"' onclick='pic_change("+i+")'></img></div>"
				if(i==1 || i==5 || i==9)
					box=box+"<div class='small_pictures_huelle_2'><img  class='small_pictures' src='"+pictures_lingerie[i].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[i].title+"' onclick='pic_change("+i+")'></img></div>"				
				if(i==2 || i==6 || i==10)
					box=box+"<div class='small_pictures_huelle_2'><img  class='small_pictures' src='"+pictures_lingerie[i].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[i].title+"' onclick='pic_change("+i+")'></img></div>"
					
				if(i==3 || i==7 || i==11)
					box=box+"<div class='small_pictures_huelle_3'><img  class='small_pictures' src='"+pictures_lingerie[i].link+"' alt='"+title_1+": "+title_2+"' title='"+pictures_lingerie[i].title+"' onclick='pic_change("+i+")'></img></div>"
		...
		{			
				  ...
				  "items": [
				    {
				      ...
				      "variant": "Black",
				      "list_position":  lingerie_selection[0].position,
				      "price": lingerie_selection[0].pricesubscription
				    }
				  ]
				});
			...
			while(i<=sizes.length-1)
			{
				...
				if(sizes[i].type=="BH")
					if(sizes[i].size.substring(0, 2)==document.getElementById("recommended_band").innerHTML && sizes[i].size.substring(2, 3)==document.getElementById("recommended_cup").innerHTML)
						document.getElementsByClassName("bra_size_select")[0].innerHTML=document.getElementsByClassName("bra_size_select")[0].innerHTML+"<option value='"+sizes[i].size+"' selected>"+sizes[i].size+"</option>"
					else
				...
				if(sizes[i].type=="panties")
				{
					panty_size=document.getElementById("recommended_panty").innerHTML
					if(panty_size!="")
					{
						panty_size_hilf=sizes[i].size.split(" ")
						if(panty_size_hilf[1]==document.getElementById("recommended_panty").innerHTML)
						{
							document.getElementsByClassName("bra_size_select")[1].innerHTML=document.getElementsByClassName("bra_size_select")[1].innerHTML+"<option value='"+sizes[i].size+"' selected>"+sizes[i].size+"</option>"
						}
						else
						{
	...
	{
		if(gesamtbewertung[0].gesamtbewertunganzahl!="0")
		{
			...
			if(gesamtbewertung[0].gesamtbewertunganzahl!="1")
				document.getElementsByClassName("anzahl_bewertungen")[0].innerHTML ="("+gesamtbewertung[0].gesamtbewertunganzahl+" Bewertungen)"
			else
				document.getElementsByClassName("anzahl_bewertungen")[0].innerHTML ="("+gesamtbewertung[0].gesamtbewertunganzahl+" Bewertung)"		
			...
			if(gesamtbewertung[0].gesamtbewertunganzahl !="1")
				...
				document.getElementsByClassName("anzahl_bewertungen_detailliert")[0].innerHTML ="("+gesamtbewertung[0].gesamtbewertunganzahl+" Bewertung)"	
	...
	var inhalt="<h1 style='font-weight:500'>"+lingerie_selection[0].name+"</h1>";
	...
	if(lingerie_selection[0].productgroup!="geschenkkarten")
	{
		if(document.getElementsByClassName("VIP")[0].innerHTML=="Regular")
			document.getElementById("preis").innerHTML="<img src='/static/180117_Banner_Erstes_Set.png' width='145'></img><div class='price_subscription'>VIP:  <strike>"+replace_dot_comma(lingerie_selection[0].pricesubscription)+" €</strike></div><div class='price_regular'><strike>Regulär: "+replace_dot_comma(lingerie_selection[0].priceregular)+" €</strike></div>"
		else
		...
		document.getElementById("preis").innerHTML="<div class='price_subscription'>"+replace_dot_comma(lingerie_selection[0].pricesubscription)+" €</div>"	
	document.getElementById("subtitle").innerHTML="<h2>"+lingerie_selection[0].descriptionshort+"</h2>";
	...
	var i=0;
	 		 ...
	 		 if(check_whether_wishlist_markiert(0)=="no")
	 			document.getElementById("add_to_wishlist_button_text").innerHTML="Auf die Wunschliste nehmen"	
			else
				document.getElementById("add_to_wishlist_button_text").innerHTML="Von der Wunschliste nehmen"
 ...
 function farbe_click(id)
 {
 	...
 	windowheight=window.innerHeight;
		...
		success: function(data) {
				window.location= "/Produktauswahl/"+url_lingerie+"/"+colors[id].detaildatabase;
 ...
 function bewertung_abrufen()
 {
	...
	if(gesamtbewertung!="")
	{
		...
		addRatingWidget(buildShopItem(Math.ceil(parseInt(gesamtbewertung[0].gesamtbewertung)/parseInt(gesamtbewertung[0].gesamtbewertunganzahl)),0),Math.ceil(parseInt(gesamtbewertung[0].gesamtbewertung)/parseInt(gesamtbewertung[0].gesamtbewertunganzahl)));
		addRatingWidget_large(buildShopItem_large(Math.ceil(parseInt(gesamtbewertung[0].gesamtbewertung)/parseInt(gesamtbewertung[0].gesamtbewertunganzahl)),1),Math.ceil(parseInt(gesamtbewertung[0].gesamtbewertung)/parseInt(gesamtbewertung[0].gesamtbewertunganzahl)));
		//	document.getElementsByClassName("c-rating__item")[0].style.background=" url('/static/stars_small.svg')";
			
		//				document.getElementsByClassName("c-rating__item")[1].style.background=" url('/static/stars_small.svg')";
 ...
 function beschreibung_abrufen()
 {
	 ...
	 document.getElementById("beschreibung_box").innerHTML="<div style='margin-left:10px;margin-right:10px;'><h3>"+text+"</h3></div>";
	 
	var text="<br><br><h3 style='line-height:25px'>"+lingerie_selection[0].details.toString()+"</h3>"
	 document.getElementById("detail_box").innerHTML="<div style='margin-left:10px;margin-right:10px;'>"+text+"</div>";
 ...
 function new_value_for_wishlist(i) {

	if(check_whether_wishlist_markiert(0)=="yes")
		status="no"
	else
		status="yes"
	button_logo(0,"add_to_wishlist_button_text","add_to_wishlist_button_logo","add_to_wishlist_button")		
 	...
 	windowheight=window.innerHeight;			
			$.ajax({
				timeout:15000,
 				error: function(){button_logo(1,"add_to_wishlist_button_text","add_to_wishlist_button_logo","add_to_wishlist_button")	},
				type: "GET",
				url: "/new_value_for_wishlist/",
				dataType: "json",
				data: { "stylecode": lingerie_selection[0].stylecode,"colorcode": lingerie_selection[0].colorcode,"status":status,"productgroup": lingerie_selection[0].productgroup,"putinwishlist":lingerie_selection[0].wishlist,"windowheight":windowheight,"windowwidth":windowwidth },
			...
			if(status=="yes")
			{
					fbq('track', 'AddToWishlist', {
						...
						document.getElementsByClassName("wishlist")[0].innerHTML=data2;
							...
							button_logo(1,"add_to_wishlist_button_text","add_to_wishlist_button_logo","add_to_wishlist_button")		
							lingerie_selection[0].wishlist=status;
				
				
							if(lingerie_selection[0].wishlist=="yes")
								document.getElementById("add_to_wishlist_button_text").innerHTML="Von Wunschliste nehmen"
							else
								document.getElementById("add_to_wishlist_button_text").innerHTML="Zur Wunschliste hinzufügen"	
...
(function ($) {
 ...
 function sizing_panty_guide_laden()
{	
	block=""
	
	
	block=block+"<div class='block_panty_sizing_guide'>\r"
	
	block=block+"<div class='sizes_panty_group'>Größe</div>\r"
	
	
	block=block+"<div class='block_panty_sizing_guide_details'>\r"

	block=block+"<div class='sizes_panty'>\r"
	block=block+"XXS\r"
	block=block+"</div>\r"
	...
	block=block+"</div>\r"		
	block=block+"<br></div>\r"		
	
	
	block=block+"<div class='block_panty_sizing_guide'>\r"
	
	block=block+"<div class='sizes_panty_group' style='margin-top:12px;line-height:20px;'>Hüftumfang<br>(cm)</div>\r"
	
	
	block=block+"<div class='block_panty_sizing_guide_details'>\r"

	block=block+"<div class='sizes_panty'>\r"
	block=block+"83<br> -<br>87"
	block=block+"</div>\r"
	
	block=block+"<div class='sizes_panty'>\r"
	block=block+"88 <br>-<br>92"
	block=block+"</div>\r"
		
	block=block+"<div class='sizes_panty'>\r"
	block=block+"93<br>-<br>97"
	block=block+"</div>\r"
	
	block=block+"<div class='sizes_panty'>\r"
	block=block+"98<br>-<br>102"
	block=block+"</div>\r"
	
	block=block+"<div class='sizes_panty'>\r"
	block=block+"103<br>-<br>107"
	block=block+"</div>\r"	

	block=block+"<div class='sizes_panty'>\r"
	block=block+"108<br>-<br>112"
	block=block+"</div>\r"	

	block=block+"<div class='sizes_panty'>\r"
	block=block+"113<br>-<br>117"
	block=block+"</div>\r"	
	box=box+"<span class='stretch'></span>\r"
	block=block+"</div>\r"		
	block=block+"</div><br><br><br>\r"			
	
	block=block+"<div class='headline_shaping_padding_guide' style='font-weight:300;text-align:left;'><b> So misst Du Deinen Hüftumfang</b><br><br>Stell Dich aufrecht hin und halte ein Maßband um den vollsten Teil Deiner Hüfte. Achte dabei darauf, dass das Maßband parallel zum Boden verläuft. Das Maßband zeigt Dir Deinen Hüftumfang.\r"
		
	document.getElementById("body_guides_other_slip").innerHTML=block;
}

function shape_padding_guide()
{	
	

	
	
	document.getElementById("body_guides_other_shaping").style.display="block";
}


function markiere_header(i,j)
{
	document.getElementById("footer_sizing_shaping_guide").style.display="none";
	if(i==0)
	{
		
		document.getElementsByClassName("block_uebersicht_auswahl_bh_sizing_guide")[0].style.display="block";		
		document.getElementsByClassName("link_gruppe_sizing_guide")[0].style.color="#b51d36";
		document.getElementsByClassName("link_gruppe_sizing_guide")[0].style.borderBottom="3px solid #b51d36"
		document.getElementsByClassName("link_gruppe_sizing_guide")[1].style.color="#818181";
		document.getElementsByClassName("link_gruppe_sizing_guide")	[1].style.borderBottom=""

		document.getElementsByClassName("link_gruppe_sizing_guide")[1].style.color="#818181";
		document.getElementsByClassName("link_gruppe_sizing_guide")[1].style.borderBottom=""				
		if(j==0)
		{
			document.getElementById("body_sizing_guide").style.display="block";
			document.getElementById("body_guides_other_slip").style.display="none";
			document.getElementById("body_guides_other_shaping").style.display="none";
			document.getElementById("footer_sizing_shaping_guide").style.display="block";
			
		//	body_sizing_guide
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.backgroundColor="#b51d36";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.color="#ffffff";

			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.backgroundColor="#ffffff";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.color="#818181";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.borderBottom="2.5px solid #b51d36";
		...
		{
			shape_padding_guide();
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.backgroundColor="#ffffff";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.color="#818181";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.borderBottom="2.5px solid #b51d36";
			
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.backgroundColor="#b51d36"
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.color="#ffffff";
			document.getElementById("body_sizing_guide").style.display="none";
			document.getElementById("body_guides_other_shaping").style.display="block";
			document.getElementById("body_guides_other_slip").style.display="none";
		}
	...
	{
			document.getElementsByClassName("block_uebersicht_auswahl_bh_sizing_guide")[0].style.display="none";		
			document.getElementsByClassName("link_gruppe_sizing_guide")[1].style.color="#b51d36";
			document.getElementsByClassName("link_gruppe_sizing_guide")	[1].style.borderBottom="3px solid #b51d36"
			document.getElementsByClassName("link_gruppe_sizing_guide")[0].style.color="#818181";
			document.getElementsByClassName("link_gruppe_sizing_guide")	[0].style.borderBottom=""
			
			
			sizing_panty_guide_laden();
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.backgroundColor="#ffffff";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.color="#818181";
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[0].style.borderBottom="2.5px solid #b51d36";
			...
			document.getElementsByClassName("uebersicht_auswahl_bh_sizing_guide")[1].style.color="#ffffff";
			document.getElementById("body_sizing_guide").style.display="none";
			document.getElementById("body_guides_other_slip").style.display="block";		
						document.getElementById("body_guides_other_shaping").style.display="none";		
