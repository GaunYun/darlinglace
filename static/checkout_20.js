...
function zur_kasse()
{
	...
	if(document.getElementById("VIP_terms_conditions_checkbox").checked==false && shopping_type=="VIP" && (document.getElementById("VIP_block").style.display=="block" || document.getElementById("VIP_block").style.display==""))
	{
...
function adresse_anzeigen(strasse_, nummer_, plz_, stadt_, vorname_, nachname_, telefonnummer_, unternehmensdetails_,adresse_neu_,land_)
{
	...
	if (strasse_=="")
	{
		box="<b>Rechnungsadresse</b><br><br>"
		box=box+"<div class='adressdetails'>"
		<div class='address_text' style='width:100%;' >Adresse<br><input  id='strasse' placeholder='Adresse eingeben'";
		box=box+"  type='text' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(0)' onkeydown='felder_adresse_zuruecksetzen(0)'></input></div><br>";
		...
		box=box+"type='text' onkeypress='validate(event)' maxlength='5' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(2)' onkeydown='felder_adresse_zuruecksetzen(2)'></div></div><br><br><br>"
		...
		box=box+"<div class='benachrichtigungen_text' onclick='unternehmen_check(this.id)' id='0'><input type='checkbox' class='checkbox_unternehmensangaben' style='cursor:pointer;float:left;'   id='checkbox_unternehmen'></input><div style='cursor:pointer;float:left;width:90%;margin-left:10px;margin-top:-2px;' id='0' onclick='click_checkbox(this.id)'>Zu einem Unternehmen liefern</div></div><br>"
	...
	//	box=box+"<input type='checkbox' id='checkbox_unternehmen' onclick='unternehmen_check()'>Zu einem Unternehmen liefern</input><br>";
		...
		box=box+"<div class='anrede_text'>Anrede<br><select class='adresse' id='street_number' style='width:90%'";
		box=box+"type='text' onkeyup='felder_adresse_zuruecksetzen(3)' onkeydown='felder_adresse_zuruecksetzen(3)' value='"+vorname_+"'><option></option><option>Frau</option><option>Herr</option></select></div>"

		box=box+"<div class='address_text'>Vorname<br><input class='adresse' id='street_number' style='width:90%'";
		box=box+"type='text' onkeyup='felder_adresse_zuruecksetzen(3)' onkeydown='felder_adresse_zuruecksetzen(3)' value='"+vorname_+"'></div>"	

		box=box+"<div class='address_text' >Nachname<br><input class='adresse' id='nachname' style='width:90%'";
		box=box+"type='text' onkeyup='felder_adresse_zuruecksetzen(4)' onkeydown='felder_adresse_zuruecksetzen(4)'></input></div><br><br>"
		
		box=box+"<div class='address_mobilnummer' >Mobilnummer<br><input class='adresse' id='street_number' onkeypress='validate(event)' maxlength='20' style='width:100%'"
		...
		box=box+"<div class='benachrichtigungen_text' onclick='click_checkbox_abweichende_lieferadresse()' ><input type='checkbox' class='checkbox_abweichende_lieferadresse' style='cursor:pointer;float:left;'   id='checkbox_abweichende_lieferadresse'></input><div style='cursor:pointer;float:left;width:90%;margin-left:10px;margin-top:-2px;' id='0' onclick='click_abweichende_lieferadresse_checkbox(this.id)'>Abweichende Lieferadresse</div></div><br>"
		document.getElementsByClassName("button_check")[0].style.display="block";



		box=box+"<br><br><br><div id='rubrik_abweichende_lieferadresse' style='display:none'><b>Abweichende Lieferadresse</b><br><br>"

		box=box+"<div class='adressdetails'><div id='locationField'><div class='address_text' style='width:100%;' >Adresse<br><input class='adresse_input' id='strasse_2' placeholder='Adresse eingeben'";
		...
		box=box+"<div ><div class='address_text' style='float:left;width:50%'>Stadt<br><input class='adresse' id='locality_2' placeholder=''";
		box=box+"type='text' style='width:100%' onkeyup='felder_adresse_zuruecksetzen(1)' onkeydown='felder_adresse_zuruecksetzen(1)'></input></div><div class='address_text' style='float:right;width:40%;'>Postleitzahl<br><input class='adresse' id='postal_code_2' placeholder=''";
		box=box+"type='text' onkeypress='validate(event)' maxlength='5' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(2)' onkeydown='felder_adresse_zuruecksetzen(2)'></div></div><br><br><br>"
		box=box+"<div class='land_text' style='width:100%;' >Land<br><input class='land_input' id='land_2' placeholder='Land eingeben'";
		box=box+"type='text' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(-1)' onkeydown='felder_adresse_zuruecksetzen(-1)'></input></div></div><br>";
		
		
		box=box+"<div class='benachrichtigungen_text' onclick='unternehmen_check(this.id)' id='1'><input type='checkbox' class='checkbox_unternehmensangaben' style='cursor:pointer;float:left;'   id='checkbox_unternehmen'></input><div style='cursor:pointer;float:left;width:90%;margin-left:10px;margin-top:-2px;' id='1' onclick='click_checkbox(this.id)'>Zu einem Unternehmen liefern</div></div><br>"
	...
	else
	{
		...
		box="<b>Rechnungsadresse</b><br><br>"	
		box=box+"<div class='adressdetails'><div id='locationField'><div class='address_text' style='width:100%;' >Adresse<br><input class='adresse_input' id='strasse' placeholder='Adresse eingeben' value='"+strasse_+"'";
		box=box+"onFocus='geolocate()'  type='text' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(0)' onkeydown='felder_adresse_zuruecksetzen(0)'></input></div></div><br>";
		...
		box=box+"type='text' onkeypress='validate(event)' maxlength='5' style='width:100%;' onkeyup='felder_adresse_zuruecksetzen(2)' onkeydown='felder_adresse_zuruecksetzen(2)' value='"+plz_+"'></div></div><br><br><br><br>";
		box=box+"<div class='land_text' style='width:100%;' >Land<br><input class='land_input' id='land' placeholder='Land eingeben'";
		...
		box=box+"<div class='address_text'>Vorname<br><input class='adresse' id='street_number' style='width:90%'";
		box=box+"type='text' onkeyup='felder_adresse_zuruecksetzen(3)' onkeydown='felder_adresse_zuruecksetzen(3)' value='"+vorname_+"'>"

		box=box+"<div class='address_text'>Anrede<br><input class='adresse' id='street_number' style='width:90%'";
		box=box+"type='text' onkeyup='felder_adresse_zuruecksetzen(3)' onkeydown='felder_adresse_zuruecksetzen(3)' value='"+vorname_+"'>"		
		
		box=box+"</input></div><div class='address_text' >Nachname<br><input class='adresse' id='nachname' style='width:90%'";
		...
		box=box+"<div class='benachrichtigungen_text' onclick='click_checkbox_abweichende_lieferadresse()' ><input type='checkbox' class='checkbox_abweichende_lieferadresse' style='cursor:pointer;float:left;'   id='checkbox_abweichende_lieferadresse'></input><div style='cursor:pointer;float:left;width:90%;margin-left:10px;margin-top:6px;' id='0' onclick='click_abweichende_lieferadresse_checkbox(this.id)'>Abweichende Lieferadresse</div></div><br>"
		document.getElementsByClassName("button_check")[0].style.display="block";
...
function check_address()
{
	...
	alert(document.getElementsByClassName ("checkbox_abweichende_lieferadresse")[0].checked)
	alert(max)
	...
	while(j<=max)
	{
		...
		if(document.getElementsByClassName("adresse_input")[j].value=="")
		{
			...
			document.getElementsByClassName("address_text")[j*5].style.color="red";		
			status=1;
		...
		while(i<=3)
		{
			...
			if(document.getElementsByClassName("adresse")[parseInt(i+6*j)].value=="")
			{
	
				document.getElementById("buttons_address_text").innerHTML="Bitte alle benötigten Felder ausfüllen.";
	
				document.getElementsByClassName("adresse")[parseInt(i+6*j)].style.border="1px solid red";	
	
				document.getElementsByClassName("address_text")[parseInt(i+5*j+1)].style.color="red";		
		...
		if(document.getElementsByClassName("adresse")[parseInt(4+j*5)].value=="")
		{
			document.getElementsByClassName("adresse")[parseInt(4+j*5)].style.border="1px solid red";	
			document.getElementsByClassName("address_mobilnummer")[j].style.color="red";	
				document.getElementById("buttons_address_text").innerHTML="Bitte alle benötigten Felder ausfüllen.";
				status=1;
				
		}
	
		if(document.getElementsByClassName("land_input")[j].value=="")
		{
			document.getElementsByClassName("land_input")[j].style.border="1px solid red";	
			document.getElementsByClassName("land_text")[j].style.color="red";	
				document.getElementById("buttons_address_text").innerHTML="Bitte alle benötigten Felder ausfüllen.";
				status=1;
				
		}
	
		if(document.getElementsByClassName("unternehmensdetails")[parseInt(j*2)].style.display=="block" && document.getElementsByClassName("unternehmensdetails")[parseInt(j*2+1)].value=="")
		{
			
						document.getElementById("buttons_address_text").innerHTML="Bitte alle benötigten Felder ausfüllen.";
				document.getElementsByClassName("unternehmensdetails")[parseInt(j*2+1)].style.border="1px solid red";	
				document.getElementsByClassName("unternehmensdetails")[parseInt(j*2)].style.color="red";	
				status=1;
...
{
	if (document.getElementsByClassName("unternehmensdetails")[id].style.display =="block")
	{
		document.getElementsByClassName("unternehmensdetails")[id].style.display ="none";
		document.getElementsByClassName("unternehmensdetails")[parseInt(id+1)].style.display ="none";
				document.getElementsByClassName("unternehmensdetails")[parseInt(id+1)].value="";

	}
	else
	{
		document.getElementsByClassName("unternehmensdetails")[id].style.display ="block";
		document.getElementsByClassName("unternehmensdetails")[parseInt(id+1)].style.display ="block";
		document.getElementsByClassName("unternehmensdetails")[parseInt(id+1)].value="";
