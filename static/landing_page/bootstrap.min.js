...
function load_header(login_)
{
	...
	box="<div class='header_block_links'><div class='header_top_style_left' style='width:300px' >Freunde einladen und erhalte 15€</div></div>\r";
	box=box+"<div class='header_block_links'><div class='header_top_style_left' >Gratis Lieferung & Rückversand</div></div>\r";
...
function insert_cart_content_in_header()
{
	...
	while(i<=cart.length-1)
	{
		...
		box=box+"<img src='"+cart[i].picture[0]+"' class='cart_dropdown_picture' onclick='content_abrufen_cart("+i+")'/>"
...
function insert_wishlist_content_in_header()
{
	...
	while(i<=wishlist.length-1)
	{
		...
		box=box+"<img src='"+wishlist[i].picture[0]+"' class='wishlist_dropdown_picture' onclick='content_abrufen_wishlist("+i+")'/>"
		...
		success: function(data2) {
			...
			if(status_=="yes")
			{
		 	...
		 	windowheight=window.innerHeight;
								...
								if(i>=0)
								{
									lingerie_selection[i].wishlist=status_;
...
function load_lingerie_sidebar(data)
{
	...
	i=0;
	 while(i<=lingerie_sidebar.length-1)
	 {
		...
		box=box+"<div class='box_1_small_image'><div><img class='image_box' src='"+lingerie_sidebar[i].pic[0][0]+"' onclick='detail_page_sidebar("+i+")'></img></div><div class='box_erste_ebene'><div class='gericht_auswahl_text' >"+lingerie_sidebar[i].name+"</div></div></div>\r";
		zaehler=zaehler+1;
...
function quiz_page_laden(seite)
{
	...
	if(seite==1)
	{
		...
		block=block+"<img  class='photo_showroom' src='/static/pictures/SLOT1-0462302526_2017_12_13_12_59_22_0881.jpg' onclick='pic_change_quiz(0,3,0)'></img>\r"
	...
	//	block=block+"<div class='block_1_text_detailliert'>...</div>\r"
		...
		block=block+"<div class='block_0'>\r"
		block=block+"<img  class='photo_showroom' src='/static/pictures/SLOT1-0462302526_2017_12_13_13_34_46_1200.jpg' onclick='pic_change_quiz(1,3,0)'></img>\r"
	...
	//	block=block+"<div class='block_1_text_detailliert'>...</div>\r"
		...
		block=block+"<div class='block_0'>\r"
		block=block+"<img  class='photo_showroom' src='/static/pictures/SLOT1-0462302526_2017_12_13_11_22_43_0223.jpg' onclick='pic_change_quiz(2,3,0)'></img>\r"
	...
	//	block=block+"<div class='block_1_text_detailliert'>...</div>\r"
		...
		block=block+"<div class='block_0'>\r"
		block=block+"<img  class='photo_showroom' src='/static/pictures/SLOT1-0462302526_2017_12_13_15_36_09_0092.jpg' onclick='pic_change_quiz(3,3,0)'></img>\r"
			...
			if(seite==2)
	{
		...
		block=block+"<div style='margin-bottom:10px'><input type='checkbox' class='color_selection'  style='cursor:pointer;float:left;height:15px;' id='check1' onclick='pic_change_quiz(0,3,1)'></input><div style='cursor:pointer;float:left;margin-left:5px;' id='0' onclick='click_checkbox(this.id)' >Hautfarben</div></div><br>\r"
		
		block=block+"<div style='margin-bottom:10px'><input type='checkbox' class='color_selection'  style='cursor:pointer;float:left;height:15px;' id='check1' onclick='pic_change_quiz(1,3,1)'></input><div style='cursor:pointer;float:left;margin-left:5px;' id='1' onclick='click_checkbox(this.id)' >Helle Farben</div></div><br>\r"

		block=block+"<div style='margin-bottom:10px'><input type='checkbox' class='color_selection'  style='cursor:pointer;float:left;height:15px;' id='check1' onclick='pic_change_quiz(2,3,1)'></input><div style='cursor:pointer;float:left;margin-left:5px;' id='2' onclick='click_checkbox(this.id)' >Dunkle Farben</div></div><br>\r"

		block=block+"<div style='margin-bottom:10px'><input type='checkbox' class='color_selection'  style='cursor:pointer;float:left;height:15px;' id='check1' onclick='pic_change_quiz(3,3,1)'></input><div style='cursor:pointer;float:left;margin-left:5px;' id='3' onclick='click_checkbox(this.id)' >Muster</div></div><br>\r"				
	...
	if(seite==8)
	{
		...
		block=block+"<fieldset>\r"	
		 ...
		 block=block+"<label for='0' style='font-weight:normal'><b>Unterbrustband engt ein</b> – Unterbrustband bekommst du nicht einfach auf den ersten Haken</label><br>\r"
		 ...
		 block=block+"<label for='1' style='font-weight:normal;'><b>Unterbrustband sitzt perfekt</b> – Unterbrustband sitzt parallel zum Boden und liegt eng am Körper an</label><br>\r"
		 ...
		 block=block+"<label for='2' style='font-weight:normal' ><b>Unterbrustband sitzt etwas locker</b> – Da das Unterbrustband etwas locker sitzt, verrutscht der BH ein wenig</label><br>\r"
...
//	'pic_change_quiz(0,3,6)'>	
	...
	if(seite==9)
	{
		...
		block=block+"<fieldset>\r"	
		 ...
		 block=block+"<label for='0' style='font-weight:normal'><b>Cup/ Bügel drücken ein</b> – Ränder des Cups bzw. die Bügel schneiden ein</label><br>\r"
		 ...
		 block=block+"<label for='1' style='font-weight:normal;'><b>Mittelsteg steht ab</b> – Mittelsteg zwischen Brüsten steht leicht ab</label><br>\r"
		 ...
		 block=block+"<label for='2' style='font-weight:normal' ><b>Cups sitzen perfekt</b> – Ränder der Cups liegen an und Bügel umfassen die Brust vollständig</label><br>\r"
		 ...
		 block=block+"<label for='3' style='font-weight:normal' ><b>Ränder der Cups stehen ab</b> – Ränder der Cups stehen ab bzw. werfen leichte Falten</label><br>\r"		
	...
	if(seite==10)
	{
		...
		block=block+"<div class='block_2'>\r"
		block=block+"<img  class='photo_showroom' src='/static/landing_page/header_image_wide.jpg'></img>\r"
