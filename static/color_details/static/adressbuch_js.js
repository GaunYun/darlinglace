...
function adresse_ok(index)
{
	...
	$.ajax({
		...
		success: function(data) {
			...
			document.getElementsByClassName("eingabefelder_vorname")[index_2].value=""
			document.getElementsByClassName("eingabefelder_nachname")[index_2].value=""
			document.getElementsByClassName("eingabefelder_telefonnummer")[index_2].value=""
			document.getElementsByClassName("eingabefelder_adresse")[index_2].value=""

			document.getElementsByClassName("eingabefelder_unternehmensdetails")[index_2].value=""
			document.getElementsByClassName("eingabefelder_stadt")[index_2].value=""
			document.getElementsByClassName("lieferhinweise")[index_2].value=""
			document.getElementsByClassName("eingabefelder_plz")[index_2].value=""
