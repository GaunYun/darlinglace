 	...
 	if(bh_groesse!="")
 	{
		...
		success: function(data) {		
				...
				$.ajax({
					...
					url: "/hello/add/",
					dataType: "json",
					data: { "add_or_erase":"add","gerichtname": lingerie_selection[0].name,"stylecode": lingerie_selection[0].stylecode,"colorcode": lingerie_selection[0].colorcode,"bh_groesse": bh_groesse,"slip_groesse": slip_groesse,"regular_price":lingerie_selection[0].priceregular,"subscription_price":lingerie_selection[0].pricesubscription,"slip_groesse_2":slip_groesse_2   },
					success: function(data) {
...
function groessentabelle()
{
			$.ajax({
			type: "GET",
			url: "/hello/account_page/groessentabelle_uebersicht/",
			dataType: "json",
			data: {'asd':'asd'  },
			success: function(data) {
					...
					$.ajax({
					type: "GET",
					url: "/hello/account_page/groessentabelle_detailliert/",
					dataType: "json",
					data: {'':''  },
					success: function(data) {
...
function add_cart_button_reset()
{
	...
	{
		document.getElementById("add_to_cart").style.backgroundColor="#DB7093";
...
function pic_change(i)
{
 	...
 	windowheight=window.innerHeight;
		 		...
		 		$.ajax({
		type: "GET",
		url: "/hello/big_data_picture_clicked/",
		dataType: "json",
		...
		success: function(data) {
				...
				if(i==0 || i==4 || i==8)
					document.getElementsByClassName("small_pictures_huelle_1")[i/4].style.backgroundColor="#DB7093";
				if(i==1 || i==5 || i==9)	
					document.getElementsByClassName("small_pictures_huelle_2")[(i-1)/4*2].style.backgroundColor="#DB7093";
				if(i==2 || i==6 || i==10)
					document.getElementsByClassName("small_pictures_huelle_2")[(i-2)/4*2+1].style.backgroundColor="#DB7093";
				if(i==3 || i==7 || i==11)
					document.getElementsByClassName("small_pictures_huelle_3")[(i-3)/4].style.backgroundColor="#DB7093";
...
window.onresize = function(event) {
   ...
   function initial_setup(resize_)
   {
	...
	document.getElementsByClassName("small_pictures_huelle_1")[0].style.backgroundColor="#DB7093";
 ...
 function getcolors()
 {
	...
	document.getElementsByClassName("colors_huelle")[0].style.backgroundColor="#DB7093";
 ...
 function farbe_click(id)
 {
 	...
 	windowheight=window.innerHeight;
 		$.ajax({
		type: "GET",
		url: "/hello/big_data_farbe_click/",
		dataType: "json",
		...
		success: function(data) {
				...
				window.location= "/hello/overview/"+url_lingerie+"/"+colors[id].detaildatabase;
 ...
 function bewertung_abrufen()
 {
 	...
 	if(bewertungen.length-1>=0)
 	{
		...
		{
			box=box+"<div class='horizontale_linie'></div><br><div style='float:left;'><div class='bewertung_name'>Von "+bewertungen[i].namebewerter+"</div><div class='bewertung_datum'>am "+bewertungen[i].bewertungsdatum+"</div></div><br><div class='shop'></div><br><div class='bewertung_headline'>"+bewertungen[i].bewertungsheadline+"</div><div class='bewertung_text'>"+bewertungen[i].bewertungstext+"</div>"
			i=i+1;
		}
 ...
 function beschreibung_abrufen()
 {
	...
	maxim[0].style.borderBottom="1.5px solid #DB7093";
 ...
 {
	var text="<br><br><br><br>"+lingerie_selection[0].details

	 
	 document.getElementById("gerichte_info_box").innerHTML="<div style='margin-left:10px;margin-right:10px;'>"+text+"</div>";
	 
	 	var maxim= document.getElementsByClassName("button_detail");
	maxim[1].style.borderBottom="1.5px solid #DB7093";
  ...
  function daten_ermitteln()
 {
	...
	var convert = function(convert){
 	...
 	windowheight=window.innerHeight;
 		...
 		$.ajax({
		type: "GET",
		url: "/hello/big_data_initial_input_detailed_page/",
		dataType: "json",
 ...
 function wishlist_abrufen(i) {
	...
	$.ajax({
		...
		dataType: "json",
		data: { "stylecode": lingerie_selection[0].stylecode,"colorcode": lingerie_selection[0].colorcode,"status":status },
 	...
 	windowheight=window.innerHeight;
		 		...
		 		$.ajax({
				type: "GET",
				url: "/hello/big_data_wishlist_put/",
				dataType: "json",
