...
//<div class='header_top_style_right' onclick='log_out_aufrufen()'>Log-out</div>	
	...
	var box_bottom_3="<div class='box_links'><div><b>Hilfe & Support</b></div><div id='support' onclick='link_abrufen(this.id)' class='links_header' >Kontaktiere uns</div><div id='versand_rueckversand' onclick='link_abrufen(this.id)' class='links_header' >Versand & Retouren</div></div>";
...
{
 // reset_sidebar()
	//$('#showroom').modal({backdrop: 'static', keyboard: false})
