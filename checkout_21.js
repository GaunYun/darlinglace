...
function adresse_anzeigen(existent_rechnungsadresse,existent_lieferadresse)
{
	...
	while(i<=1)
	{
		...
		box=box+"<br><div class='address_unternehmensangaben_input_header' style='display:none'>Unternehmensangaben<br><input type='text' class='unternehmensdetails' id='unternehmensdetails_id' placeholder=''></input><br></div>";
...
page_load(1);
 ...
 function paypal_laden()
 {
 	...
 	document.getElementById("kreditkarten").innerHTML="<br><div style='line-height:20px;' onclick='actions.payment.create()'><b>Mit Paypal zahlen</b><br><br>Nachdem du bestellt hast, wirst du im nächsten Schritt zu Paypal weitergeleitet. Nach der Bezahlung hast, gelangst du zur Bestellbestätigung.</div><br>";
 ...
 function kreditkarten_anzeigen()
 {
		...
		box=box+"<br><div style='float:right;margin-bottom:40px;margin-top:40px;width:100%;'>"
		...
		box=box+"<div class='benachrichtigungen_text' ><input type='checkbox'  style='cursor:pointer;float:left;'  id='zahlungsdaten_checkbox' ></input><div style='cursor:pointer;float:left;width:90%;margin-left:10px;margin-top:-2px;'  onclick='zahlungsdaten_speichern()'>Speichern für weitere Käufe</div></div><br>"
